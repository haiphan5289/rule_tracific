...
class oto_detail: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tb_detail.register(oto_title.self, forCellReuseIdentifier: "oto_title")
        tb_detail.register(oto_object.self, forCellReuseIdentifier: "oto_object")
        tb_detail.register(oto_des.self, forCellReuseIdentifier: "oto_des")
        tb_detail.register(oto_price.self, forCellReuseIdentifier: "oto_price")
    ...
    func navi_bar_setup_autolayout(){
        ...
        //add navigation item
        let naviitem: UINavigationItem = UINavigationItem(title: "Chi tiết")
...
extension oto_detail: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if rule_detail.title == element_detail {
            ...
            let cell = tb_detail.dequeueReusableCell(withIdentifier: "oto_title") as! oto_title
            ...
            let cell = tb_detail.dequeueReusableCell(withIdentifier: "oto_object") as! oto_object
            ...
            let cell = tb_detail.dequeueReusableCell(withIdentifier: "oto_des") as! oto_des
            cell.des.text = element_detail
            let height = estimate_size_for_text(text: element_detail as! String).height
            cell.height_des.constant = height + 20
            ...
            let cell = tb_detail.dequeueReusableCell(withIdentifier: "oto_price") as! oto_price
            cell.des.text = element_detail
