...
class des_cell: UITableViewCell {

    var title_obj: UILabel!
    var des: UITextView!
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        super.init(style: .default, reuseIdentifier: objec_cell_text)
...
//        des.text = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        des.textAlignment = .natural
//        des.backgroundColor = UIColor.orange
        ...
        des.widthAnchor.constraint(equalTo: self.widthAnchor, constant: -16).isActive = true
